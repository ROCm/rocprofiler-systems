...
.. code-block:: shell
   ...
   | sampling_gpu_power                | GPU Power Usage via AMD-SMI. Derived fro... |
   | sampling_gpu_temp                 | GPU Temperature via AMD-SMI. Derived fro... |
   | sampling_gpu_busy                 | GPU Utilization (% busy) via AMD-SMI. De... |
   | sampling_vcn_busy                 | GPU VCN Utilization (% activity) via AMD-... |
   | sampling_gpu_memory_usage         | GPU Memory Usage via AMD-SMI. Derived fr... |
   |-----------------------------------|----------------------------------------------|
