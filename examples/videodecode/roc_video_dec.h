...
public:
     ...
     */
    virtual int DecodeFrame(const uint8_t* data, size_t size, int pkt_flags,
                            int64_t pts = 0, int* num_decoded_pics = nullptr);
    /**
     ...
     * dumped to file
     */
    virtual void SaveFrameToFile(std::string output_file_name, void* surf_mem,
