...
# ----------------------------------------------------------------------------------------#
macro(rocprof_sys_begin_flag_check)
    if(ROCPROFSYS_QUIET_CONFIG)
        if(NOT DEFINED CMAKE_REQUIRED_QUIET)
            set(CMAKE_REQUIRED_QUIET OFF)
        endif()
        rocprof_sys_save_variables(FLAG_CHECK VARIABLES CMAKE_REQUIRED_QUIET)
...
# ----------------------------------------------------------------------------------------#
macro(rocprof_sys_end_flag_check)
    if(ROCPROFSYS_QUIET_CONFIG)
        rocprof_sys_restore_variables(FLAG_CHECK VARIABLES CMAKE_REQUIRED_QUIET)
    endif()
endmacro()
...
# check flag
# ----------------------------------------------------------------------------------------#
function(ROCPROF_SYS_TARGET_FLAG _TARG_TARGET)
...
# ----------------------------------------------------------------------------------------#
function(ROCPROF_SYS_TARGET_COMPILE_DEFINITIONS _TARG _VIS)
    foreach(_DEF ${ARGN})
