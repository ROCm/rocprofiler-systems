...
# ----------------------------------------------------------------------------------------#
macro(rocprofsys_begin_flag_check)
    if(ROCPROFSYS_QUIET_CONFIG)
        if(NOT DEFINED CMAKE_REQUIRED_QUIET)
            set(CMAKE_REQUIRED_QUIET OFF)
        endif()
        rocprofsys_save_variables(FLAG_CHECK VARIABLES CMAKE_REQUIRED_QUIET)
...
# ----------------------------------------------------------------------------------------#
macro(rocprofsys_end_flag_check)
    if(ROCPROFSYS_QUIET_CONFIG)
        rocprofsys_restore_variables(FLAG_CHECK VARIABLES CMAKE_REQUIRED_QUIET)
    endif()
endmacro()
...
# check flag
# ----------------------------------------------------------------------------------------#
function(ROCPROFSYS_TARGET_FLAG _TARG_TARGET)
...
# ----------------------------------------------------------------------------------------#
function(ROCPROFSYS_TARGET_COMPILE_DEFINITIONS _TARG _VIS)
    foreach(_DEF ${ARGN})
