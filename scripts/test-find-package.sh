...
if [ ! -f "${INSTALL_DIR}/include/rocprof-sys/user.h" ]; then
    if [ -z "${INSTALL_SCRIPT}" ]; then
        error-message "Unable to find \"rocprof-sys/user.h\" in \"${INSTALL_DIR}/include\" and installation script not provided"
